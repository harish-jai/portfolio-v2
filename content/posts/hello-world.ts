...
export const samplePost: WritingItem = {
  ...
  I've built a couple iterations of this portfolio in the past, but it always seemed too cluttered, to the point where the UI detracted from the content.
  ...
  I feel that resumes flatten my work into bullet points and while it's an efficient way to highlight my experience, I wanted a place to show case my work in a more narrative way and capture why certain decisions were made.
  ...
  In this video, he made a good point about making documenting fun. He emphasized the importance of using the right tools.
  ...
  Cortado, my current side project, uses semantic search to let users find the most relevant notes to what they need.
  ...
  For my site, a chatbot would be overkill, but I liked how the semantic search worked in Cortado and wanted to try it out here, especially given this site has a smaller corpus of content.
  ...
  I'm excited to see how well the search system works as I continue to use it myself (maybe it'll inspire some changes for Cortado)!
